...
> Note: If you already installed an old version of the script called "musescore-downloader" or "MSCZ downloader", please uninstall it from the Tampermonkey dashboard
