...
> Las conversiones incluyen: Partes individuales, PDF, PNG, SVG, MP3, WAV, FLAC, OGG, MIDI, MusicXML, MSCZ y MSCX.

### Aplicación

1. Vaya a la página [README](https://github.com/LibreScore/app-librescore#installation) del repositorio `app-librescore`.
2. Sigue las instrucciones de instalación de tu dispositivo para instalarlo

### Script del usuario

> Nota: Si su dispositivo iOS o iPadOS, por favor, siga las instrucciones de [Atajo](https://github.com/LibreScore/dl-librescore#shortcut).
>
> Nota: Si no puede instalar las extensiones del navegador en su dispositivo, por favor, siga las instrucciones de [Marcador](https://github.com/LibreScore/dl-librescore#bookmark) en su lugar.
